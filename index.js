...
restService.post('/employee', function (req, res) {
  ...
  data_layer.employees(req.body.result.parameters.employeeId, (response) => { res.json({ speech: response, displayText: req.body.result.parameters.employeeId, source: "meritus-bot" }); });
});
